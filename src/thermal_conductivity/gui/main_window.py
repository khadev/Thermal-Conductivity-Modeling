...
class MainWindow(QMainWindow):
    def __init__(self, mode="nanothermite"):
        ...
        # ===== WINDOW SETUP =====
        self.setWindowTitle(f"{self.mode_icon} Thermal Conductivity Modeling Suite v3.0")
    ...
    def _build_models_html(self):
        ...
        <div style="margin-top: 20px; padding: 12px; background: #f8f9fa; border-radius: 6px; text-align: center; font-size: 11px; color: #95a5a6;">
            Thermal Conductivity Modeling Suite v3.0 • {self.mode_label} Mode • Generated: {pd.Timestamp.now().strftime('%Y-%m-%d %H:%M')}
        </div>
        """
    ...
    def update_report_preview(self):
        try:
            ...
            html += f"<hr><p style='color:#7f8c8d;font-size:11px;'>Generated by Thermal Conductivity Modeling Suite v3.0 - {self.mode_label} Mode | Oukil Khaled</p>"
    ...
    def generate_report(self):
        ...
        try:
            ...
            meta = {
                ...
                "Software": (
                    f"Thermal Conductivity Modeling Suite v3.0 - "
